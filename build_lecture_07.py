...
TARGET_DIR = "/home/m/projects/slides/logharitm-slides-source/lectures/lecture-07"
...
<title>المحاضرة 07 &middot; {title} &mdash; شريحة {pad(curr_num)}</title>
...
if __name__ == "__main__":
    print("build_lecture_07.py ready.")
